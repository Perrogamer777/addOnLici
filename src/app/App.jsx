...
const skusAgregados = useMemo(() => 
  ...
  // Mostrar mensaje de error si no es una licitación
  if (errorTicket) {
    return (
      <div className="p-4">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700">
                <p>El título del ticket debe contener el formato <strong>LIC-XXX</strong></p>
              </div>
              <div className="mt-3 text-xs text-red-600">
                Ejemplo: "Cotización para LIC-123"
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <>
      <main ref={mainRef} className="...">
        <h1 className="text-2xl font-bold mb-4">{licitacionData?.tipoLicitacion || "Sin Tipo asignado"} desde {licitacionData?.origen || "Origen Desconocido"}</h1> 
