            ...
            {items.map(item => (
              <tr key={item.id} className="hover:bg-gray-50">
                ...
                <td className="p-3 text-center">
                  <button type="button" className="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full hover:bg-blue-200" onClick={() => onSugerenciaClick(item.descripcion)}>
                    Ir a sugerencia
                  </button>
                </td>
              </tr>
