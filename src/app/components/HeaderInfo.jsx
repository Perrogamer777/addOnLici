...
export default function HeaderInfo({ info }) {
  ...
  return (
    <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg grid grid-cols-4 gap-4 text-sm">
      ...
      <div className="relative">
        ...
        {comentarios ? (
          <div className="relative inline-block ml-2">
            ...
            {showTooltip && (
              <div className="absolute top-6 right-0 z-10 w-80 p-3 bg-white border border-gray-300 rounded-lg shadow-lg text-xs text-gray-700 leading-relaxed">
